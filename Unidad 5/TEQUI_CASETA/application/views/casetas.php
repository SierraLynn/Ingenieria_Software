<?php
$data = $this->Administrador->vercaseta();
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
        ...
        <div class="col-xs-10 col-xs-offset-1">
          <center><img src="https://raw.githubusercontent.com/SierraLynn/Ingenieria_Software/master/223.png"  width="350" height="260" alt=""></center>
...
<?php 
 ...
 ?>
  <tr>
    <td class="form"><?=$fila['id_caseta'];?></td>
    <td><?=$fila['Numero'];?></td> 
    <td><?=$fila['Peso'];?></td>
    <td><?=$fila['Fecha_llegada'];?></td>
    <td><?=$fila['id_alimento'];?></td>
    <td><?=$fila['id_etapa'];?></td>
  ...
  <tr>
    ...
    <td></td>
            ...
            ?>
                 ...
                 <center>  
        <a type="button" class="btn btn-warning" href="agreCas" >Agregar</a>
        <a type="button" class="btn btn-warning" href="editCas" >Editar</a>
