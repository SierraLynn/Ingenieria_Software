<?php
$data = $this->Administrador->veretapa();
?>
<!DOCTYPE html>
<html>
<head>
...
<center><img src="https://raw.githubusercontent.com/SierraLynn/Ingenieria_Software/master/102.png"  width="300" height="240" alt=""></center> 
...
<?php 
 ...
 ?>
  <tr>
    <td class="form"><?=$fila['id_etapa'];?></td>
    <td><?=$fila['Etapa'];?></td> 
  ...
  <tr>
    ...
    <td></td> 
            ...
            ?>
                 ...
                 <center>  
        <a type="button" class="btn btn-warning" href="agreEta" >Agregar</a>
        <a type="button" class="btn btn-warning" href="editEta" >Editar</a>
